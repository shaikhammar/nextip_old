...
export const clientFormSchema = z.object({
    name: z.string().max(50, { message: "Client name too large. Please use below address field." }).optional(),
    code: z.
        string()
    ...
    email: z.string().email({ message: "Invalid email. Please enter a valid email." }).optional(),
